...
export function spliceArrayBuffer(
	arr?: ArrayBuffer | any,
	start?: number,
	end?: number,
	endian?: boolean,
...
export function fastestFunction(
	fns: any[],
	iterations?: number,
): number;
...
export function forTemplateLiteral(
	arr?: any[],
	callback?: Function,
): string;
