...
export function each(array?: any[] | string | number, callback?: Function): any[];
...
export function replaceText(el?: Element, callback?: Function): HTMLElement;
...
export function addEventListeners(element?: Element, events?: Array<string>, handler?: Function, useCapture?: boolean | any, args?: any[]): Element;
export function sortTable(element?: HTMLTableElement, cellVal?: Function): HTMLTableElement;
...
export function animate(start?: number, end?: number, duration?: number, callback?: Function, interval?: number, num?: Function): number;
