...
let _temp = {
  ...
  addStyles: (e, t) => Object.assign(e.style, t),
  onOutsideClick: (e, t) => {
      ...
      n
        ? (clearTimeout(r),
          (r = setTimeout(function () {
            Date.now() - o >= t && (e.apply(a, i), (o = Date.now()))
          }, Math.max(t - (Date.now() - o), 0))))
        : (e.apply(a, i), (o = Date.now()), (n = !0))
    }
  },
  createElement: (e) => {
    ...
    if (window.Notification)
      if ("granted" === Notification.permission)
        ...
        Notification.requestPermission()
          .then(function (r) {
            if ("granted" === r) new Notification(e, { body: t, icon: n })
            else console.log("User blocked notifications.")
          })
          .catch(function (e) {
            console.error(e)
          })
    else console.log("Browser does not support notifications.")
  },
  dayName: (e, t) => e.toLocaleDateString(t, { weekday: "long" }),
  jsonToCsv: (e, t, n = ",") =>
    [
      t.join(n),
      ...e.map((e) =>
        t.reduce((t, r) => `${t}${t.length ? n : ""}"${e[r] ? e[r] : ""}"`, ""),
      ),
    ].join("\n"),
  unionArrays: (e, t) => {
  ...
  mapObjectKeys: (e, t) =>
    Array.isArray(e)
      ...
      ? Object.keys(e).reduce((n, r) => {
          ...
          return (
            (n[o] =
              null !== a && "object" == typeof a ? _$.mapObjectKeys(a, t) : a),
            n
          )
        }, {})
      : e,
  arrayToCSV: (e, t = ",") =>
    e
      .map((e) =>
        e.map((e) => (isNaN(e) ? `"${e.replace(/"/g, '""')}"` : e)).join(t),
      )
      .join("\n"),
  averageBy: (e, t) =>
    e.map("function" == typeof t ? t : (e) => e[t]).reduce((e, t) => e + t, 0) /
    e.length,
  inView: (e) => {
    for (
      var t = e.offsetTop,
  ...
  formToObject: (e) =>
    Array.from(new FormData(e)).reduce((e, [t, n]) => ({ ...e, [t]: n }), {}),
  uuid: () =>
  ...
  replaceText: (e, t) => {
    for (
      var n,
        r = (function () {
          for (var t, n = e, r = [], o = 0; o < n.length; o++)
            (t = n[o].childNodes[0]),
              n[o].hasChildNodes() && 3 == t.nodeType && r.push(t)
          return r
        })(),
        o = 0,
        a = r.length;
      ...
      (n = r[o].nodeValue), (r[o].nodeValue = t(n))
  },
  timeFunction: (e, t = "_ function timer") => {
  ...
  widows: (e) => {
    for (var t = e.split(" "), n = "", r = 0; r <= t.length - 1; r++)
      (n += t[r]), r == t.length - 2 ? (n += "&nbsp;") : (n += " ")
    return n
  },
    ...
    return (
      e.match(/^rgb/)
        ...
        : ((t =
          ...
          (n = (e >> 8) & 255),
          (r = 255 & e)),
      (o = Math.sqrt(t * t * 0.299 + n * n * 0.587 + r * r * 0.114)) > 127.5
        ? { lightordark: "light", hsp: o }
        : { lightordark: "dark", hsp: o }
    )
  },
  compStyle: (e, t) => window.getComputedStyle(e).getPropertyValue(t),
  rgbToHex: (e) => {
    let t = e.indexOf(",") > -1 ? "," : " ",
  ...
  querySelector: (e) => {
    ...
    return (
      (function e(n) {
        if (
          n.getAttribute("id") &&
          1 === document.querySelectorAll(`#${n.getAttribute("id")}`).length
        )
        ...
        if (n.getAttribute("class")) {
          var r = "."
          r = (r = (r += n.getAttribute("class")).replace(/\s/g, ".")).replace(
            /^/g,
            " ",
          )
          var o = ""
          if ((c = n.parentNode.children).length < 2) return
          for (var a = [], i = 0; i < c.length; i++)
            n.getAttribute("class") == c[i].getAttribute("class") &&
              a.push(c[i])
          if (a.length > 1)
          ...
          var c,
            u = ""
          if ((c = n.parentNode.children).length > 2) {
            var d = []
            for (i = 0; i < c.length; i++)
              n.nodeName == c[i].nodeName && d.push(c[i])
            if (d.length > 1)
  ...
  spliceArrayBuffer: (e, t, n, r) => {
    ...
    for (var a = t, i = 0; a != n; a += o) i = 256 * i + e[a]
    return i
  },
  ...
  parseHTML: (e, t = "text/html") => new DOMParser().parseFromString(e, t),
}
